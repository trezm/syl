...
Every comment staged from a finding ends with a *Generated by syl* line linking
back to this repo, so a reader of the pull request can tell at a glance which
comments a model wrote. It's part of the editable body — delete it if you've
rewritten the comment enough to call it yours.
